 ...
 */
public class GinkgoDIChangeLogPanel extends javax.swing.JPanel {

    private Class<?> clazz;

    /** Creates new form ChangeLogPanel */
    public GinkgoDIChangeLogPanel(Class<?> clazz) {
        this.clazz = clazz;
        initComponents();
        initTable();
    }
    ...
    public DefaultTableModel getTableModel() {
        ...
        BasextComments commentsAnnotation = clazz.getAnnotation(BasextComments.class);
        if (commentsAnnotation != null) {
            BasextCommentItem[] commentItems = commentsAnnotation.value();
            if (commentItems != null) {
                for (BasextCommentItem item : commentItems) {
